...
for(let ch in newCountryList){
  ...
  let fetching = async()=>{
    let curr = await fetch(`https://api.freecurrencyapi.com/v1/latest?apikey=fca_live_Dku6HS3kt3YRBvLu0stztbtCJCf9VuYaHesqYjdm&currencies=${selectto.value}&base_currency=${selectfrom.value}`);
